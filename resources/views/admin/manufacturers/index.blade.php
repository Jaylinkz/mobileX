    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row">
                ...
                <div class="col-sm-3">
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/manufacturers', 'role' => 'search'])  !!}
            ...
            <div class="table-responsive">
                    ...
                    @foreach($manufacturers as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::open([
                                    'method' => 'DELETE',
                                    'url' => ['/admin/manufacturers', $item->id],
                ...
                <div class="pagination-wrapper"> {!! $manufacturers->appends(['search' => Request::get('search')])->render() !!} </div>
            </div>
