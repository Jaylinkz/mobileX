...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-title">
                <a href="{{ url('/admin/suppliers/create') }}" class="btn btn-success btn-sm" title="Add New User">
                    <i class="fa fa-user" aria-hidden="true"></i>
                    <span class="bold"> Add Supply</span>
                </a>
        ...
        <div class="ibox-content">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th>#</th><th>Name</th><th>Address</th><th>Mobile Number</th><th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
