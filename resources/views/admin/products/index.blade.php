...
<div class="container-xl w-100 p-3">
	...
	<div>
		<form action="{{route('updateRated')}}" method="POST">
			@csrf
			<div class="form-group">
				@foreach ($rate as $rat )
				<p><strong>current rate: {{$rat->exchange_rate}}</strong></p>
				@endforeach
			</div>
			<div class="form-group">
			...
			<form method="POST" action="{{route('manageProducts.store')}}">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="r_quantity" required>
					</div>
					<div class="form-group">
						<p>categories</p>
