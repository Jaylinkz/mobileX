...
<body>
	...
	<form method="post" action="{{route('search')}}">
		...
		<div class="input-group no-border">
			...
			<input type="text" value="" name="item" onmouseover="this.focus();" class="form-control" placeholder="Search...">
					...
					<tr>
						...
						<td>
							...
							<form method="POST" action="{{route('cart.add')}}">
								...
								<div class="form-group">
								<button class="btn btn-success" data-toggle="modal">cart</button>
							</div>
							</form>
							@endif
							@endisset
