...
<body>
	@if(session('message'))
	<div class="height-100 width-200">{{session('message')}}</div>
	@endif
            ...
            <div class="modal-content">
                <form method="POST" action="{{route('saveSale')}}">
                    ...
                    <div class="modal-body">
						...
						<div class="form-group">
						<select  id="categories" name="sale_type" class="form-multiselect block w-full mt-1" >
							<option >credit</option>
							<option >cash</option>
						  </select>
						</div>
                        <div class="form-group">
                            <select  id="categories" name="payment_method" class="form-multiselect block w-full mt-1" multiple>
                                <option >cash</option>
                                <option >POS</option>
